...
const Team = () => {
  ...
  const MemberCard = ({ m }) => (
    <div className="group relative flex flex-col md:flex-row bg-[#0a0a0a] rounded-[30px] sm:rounded-[40px] border border-white/5 overflow-hidden transition-all duration-700 hover:border-[#e63c3c]/40 hover:shadow-[0_20px_60px_rgba(230,60,60,0.15)]">
